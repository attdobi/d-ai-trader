...
sep_before: ""
sep_after: ""
body_sha256: 75de422a00204c394b30c4555e53df8796714b9fcf1dcdf8a4f86b1a2b23d26a
tags: []
tickers: []
---
...
PROCESS CHECKLIST
1. Screenshot evidence first: visible tickers, charts, VWAP, 10m trend, volume, sector/index cues, timestamps.
2. Text evidence second: headlines, news age, source crowding, catalyst specificity.
...
4. For each selected ticker, decide: fresh_confirmed, fresh_unconfirmed, stale, failing, or no_catalyst.
5. Prefer avoid/watch labels over false conviction when confirmation is missing.
...
- Catalyst status definitions:
  ...
  - `fresh_unconfirmed`: under 24–48h old but VWAP/10m/volume/sector confirmation is missing or not visible.
  ...
  - `failing`: bullish/bearish story is contradicted by visible price action, weak 10m trend, below VWAP, near lows, sector conflict, pinned tape, or failed follow-through.
...
- Insights: one paragraph only, 160–220 words, covering regime, sector tilt, key company catalysts, failed/stale narrative risks, inherited/synced inventory risk if present, and 1–2 intraday triggers. End with `Watchlist:` followed by 3–8 tickers ordered by conviction.
- No invented tickers, holdings, technicals, prices, percentages, timestamps, analyst claims, or macro speculation without a concrete input cue.
