...
sep_before: ""
sep_after: ""
body_sha256: 9d54e1832691290cc8d792b13791f5cc7ebb2aa4e78c514e3edfdd3d7c5bed5a
tags: []
tickers: []
---
ACCOUNT
...
- Step 1: Inventory quarantine and A/B/C triage before new entries.
  ...
  • If confirmation fields are missing or vague, count them as unconfirmed rather than assuming strength.
...
- Step 4: New BUY filter.
  ...
  • Also require the setup not to be an obvious exhausted chase: if extended/pulled from highs, buy only if still above VWAP, near highs, with expanding volume and persistent relative strength.
...
- Missing VWAP/10m/relative-strength/volume/catalyst-age evidence means no confirmed edge.
