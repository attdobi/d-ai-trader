...
compiled: stored
locked: false
provenance: prompt_versions#588
sep_before: ""
sep_after: ""
body_sha256: c1ab311afcae95654598dae5bd09ee600db076792b64ca89a5dd8edf7b84b769
tags: []
tickers: []
---
ACCOUNT
...
- For each ticker actually weighed, use the existing signals string as a compact, semicolon-separated evidence record: catalyst age/source; price vs VWAP; 10m trend; relative volume; RS vs sector/index; peer confirmation; distance vs 20d.
- State unavailable facts as UNKNOWN. Do not substitute a headline, monthly trend, or prior narrative for an UNKNOWN tape or catalyst field.
- In why, state the verdict and the exact disqualifier for a reject. This audit records available evidence; it does not override the stated allowance for unavailable intraday micro-signals on otherwise valid pullbacks.
