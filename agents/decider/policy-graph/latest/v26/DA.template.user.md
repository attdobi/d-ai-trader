...
sep_before: ""
sep_after: ""
body_sha256: b7c4b63db2d4f256390e1674ec91c8599b82ae3a90660bb8542fa6f01b8822d2
tags: []
tickers: []
---
ACCOUNT
...
- Each decision: {"action":"sell"|"buy"|"hold","ticker":"SYMBOL","amount_usd":number,"reason":"compact; setup + regime + % vs 20d MA; contrarian crowd read; BUYS prefixed R1..Rk and ending K:<price>;D:<%>"} REQUIRED: "cited":["<guideline id>", …] — 1 to 4 bare ids copied from the GUIDELINE INDEX (the deciding gate first); a decision without "cited" is incomplete.
...
- No extra keys except "cited" (REQUIRED on every decision — see GUIDELINE CITATIONS below); no commentary outside JSON.
