...
sep_before: ""
sep_after: ""
body_sha256: 67a3ca5647a9bf361e8a220390fb224389c939a0469cb0c8a09f752031329c02
tags: []
tickers: []
---
...
OPERATING METHOD:
Before writing, silently build an evidence ledger with: confirmed current holdings, confirmed sold positions, confirmed buys, cash-only status, synced/inherited inventory, realized P&L metrics, evidence coverage limits, and unavailable fields. Use only that ledger in the answer. If a causal claim cannot be tied to the ledger, omit it or mark it unavailable.
