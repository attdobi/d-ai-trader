...
sep_before: ""
sep_after: ""
body_sha256: 015f20b0ff6888a3597c00b33707ab76b9ca2bd8d50fd586a9ec71fca6aee307
tags: []
tickers: []
---
...
EXPECTANCY FOCUS:
Start from the computed diagnostics when supplied. Audit in this order: 1) regime — did the same rules win in RISK-ON and lose in RISK-OFF; 2) entry geometry — extension above the 20d MA at entry and distance to the kill (an unpriced '20d break' is the loss tail); 3) same-ticker re-entry within 3 days of an exit; 4) payoff — breakeven win rate versus actual; 5) position-state integrity and synced inventory; 6) catalyst freshness plus price confirmation; 7) data-quality errors. Do not produce a generic checklist. Do not overfit one anecdote, and do not soften a rule the diagnostics support because the sample is small.
